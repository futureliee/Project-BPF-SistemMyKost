<div class="main-panel">
    ...
    <div class="content">
        <div class="container-fluid">
        <h3 class="mb-3"><?=$kamar["lantai"]?></h3>
        <div class="row">
        <img 
        <?php if($kamar["fotokamar"]==null){?>
        src="<?=base_url().'assets/img/Home.png'?>"
        <?php }else{?>
            src="<?=base_url().'assets/img/gambar_kamar/'.$kamar['fotokamar']?>"
            <?php }?>
            ...
            <table border="0" style="width: 60%">
                    ...
                    <tr>
                        <th>Nama Penghuni </th>
                        <td> : <?=$kamar["nama_penghuni"]?></td>
                    </tr>
                    <tr>
                        <th>Pembayaran </th>
                        <td> :  <?=$kamar["pembayaranKamar"]?></td>
                    </tr>
                    <tr>
                        <th>Harga </th>
                        <td> : Rp <?=number_format($kamar["biayaKamar"],0,',','.')?></td>
                    </tr>
                    <tr>
                        <th>Status Kamar </th>
