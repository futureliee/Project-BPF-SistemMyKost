...
<div class="main-panel">
    ...
    <div class="content">
        <div class="form-inline mb-2">
            <input type="text" class="form-control col-md-6" id="searchField" placeholder="Ketik nama kost atau alamat"
                aria-describedby="emailHelp">
            <button class="btn btn-info ml-2" id="searchBtn">Cari</button>
        </div>
        <div class="filter mb-6">
            Filter by :
            <button type="button" class="btn btn-info ml-3 btn-sm pilihKota" data-toggle="modal"
                data-target="#pilihKota">Kota / Kabupaten : Semua</button>
            <button type="button" class="btn btn-info ml-1 btn-sm pilihPembayaran" data-toggle="modal"
                data-target="#pilihPembayaran">Pembayaran : Semua</button>
            <button type="button" class="btn btn-info ml-1 btn-sm pilihJenis" data-toggle="modal"
                data-target="#pilihJenis">Jenis : Semua</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label " for="exampleRadios1">Kota Pekanbaru
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="filterKota" id="exampleRadios1"
        ...
        <div class="modal fade" id="pilihJenis" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="filterJenis" id="exampleRadios2"
                                value="Semua" checked>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="filterJenis" id="exampleRadios3"
                                value="Putri">
        ...
        <!-- Modal -->
        <div class="modal fade" id="pilihPembayaran" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="filterPembayaran" id="exampleRadios2"
                                value="Semua" checked>
                            <label class="form-check-label" for="exampleRadios2">
                                Semua
                            </label>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="filterPembayaran" id="exampleRadios3"
                                value="Setengah Tahun">
                            <label class="form-check-label" for="exampleRadios3">
                                Setengah Tahun
                            </label>
                        </div>
